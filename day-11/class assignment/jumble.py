#fetch_words: This is a method defined within the class. 
# #The method is being called on the current instance (self).
import random
...
class WordJumbleGame(object):
    ...
    def fetch_words(self, file):
        path=r"C:\Users\237237\Desktop\anacondacode\day-11\class assignment\words.txt"
        f = open(path)
        content = f.read()
        f.close()
